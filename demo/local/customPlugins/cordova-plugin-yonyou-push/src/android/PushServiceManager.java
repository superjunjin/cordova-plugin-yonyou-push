...
/* 149 */           Intent intent = new Intent(Constants.getServiceAction());
                    Intent eintent = new Intent(createExplicitFromImplicitIntent(PushServiceManager.context,intent));
/* 150 */           PushServiceManager.context.startService(eintent);
/*     */         }
/*     */       });
...
/* 183 */     Intent intent = new Intent(Constants.getServiceAction());
              Intent eintent = new Intent(createExplicitFromImplicitIntent(PushServiceManager.context,intent));
              PushServiceManager.context.stopService(eintent);
